    ...
    <div class="first-sect">
      <div class="container flex flex-col items-center justify-center h-screen">
        <div class="content pb-32">
          ...
          <p class="w-2/4 leading-normal max_lg:w-4/5 max_md:text-center max_md:w-full">
      ...
      <div class="container flex flex-col items-end max_lg:items-center">
        <div class="services-title text-right w-3/5 max_lg:text-center max_sm:w-full">
          ...
          <p class="text-green-600">
            Мы работаем с любыми типами грузов и организовываем поставки из любой точки мира под
            различными таможенными процедурами. Гарантируем сохранность груза на всех этапах
            перевозки и таможенного оформления. Мы смогли настроить операционную работу на
            собственном специализированном терминале в г. Ангрен и на складах Кореи, Китая, Европы,
        ...
        <div id="carouselExampleIndicators" class="carousel slide">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div>
                <img src="/public/partners/1.jpg" class="d-block" width="147" alt="..." />
              </div>
            </div>
            <div class="carousel-item">
              <img src="/public/partners/2.png" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
